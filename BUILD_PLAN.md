...
- Android app: [`examples/android/`](examples/android/) · `dev.foss.expeditiongauge` · **v2.18.9** (2026-08-21).
- **Shipped:** through **v2.18.9** (donate + daily installer update check). Audit 2026-07-29 archived.
