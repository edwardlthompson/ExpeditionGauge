...
- Concentric rings at 10° / 20° / 30° reference
- Crosshairs; animated ball from calibrated pitch/roll
- Digital readouts: `Pitch: ±XX.X°`, `Roll: ±XX.X°`
- Color zones: green / yellow / red by threshold
- **Calibrate / Set Level** button prominent on panel
